    ...
    <CreatePaymentNowContainer
      ...
      <Box className="container bg-[#fff]  ">
        <Grid container className="p-[20px]">
          ...
          <Grid item xs={12} md={12} className="mt-[10px] bg-[#F5F5F5] p-[4px]">
          ...
          <Grid item xs={12} md={12} className=" bg-[#F5F5F5] p-[4px]">
            <ReceptionTable columnDefs={ConnectionCol} rowData={rowData} />
          </Grid>
          <Grid
            item
            xs={12}
