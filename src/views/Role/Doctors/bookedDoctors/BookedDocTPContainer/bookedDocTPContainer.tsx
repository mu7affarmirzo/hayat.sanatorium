...
import useDocTPBookedTitleHook from './hook';
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Grid container className="flex ">
          ...
          <Grid
            ...
            xs={12}
            md={12}
            className="bg-white m-[5px] border min-h-[calc(100vh-320px)] h-[calc(100vh-320px)] overflow-scroll p-[5px]"
            ref={scrollRef}
...
export default BookedDocTPContainer;
