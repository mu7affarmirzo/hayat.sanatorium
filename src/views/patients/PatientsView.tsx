...
const rowData = [
    {
        ...
        mainDiagnos: "-- - Гипертоническая болезнь III АГIII. риск IV. ИБС-стенокардиянапряжения ФК II.",
...
const PatientsView = () => {
    return (
        <Grid className="" container>
            <Grid className="flex justify-between items-center  my-[10px] " item xs={12} md={12}>
