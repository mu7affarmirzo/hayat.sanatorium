    ...
    <Grid container>
      <Grid item xs={12} className="min-h-[200px]">
        <Grid container className="flex justify-between h-[100%]">
          <Grid item xs={5.9} className="bg-[#fff]  p-[5px] h-[100%] w-full">
            <Typography className="text-[14px] text-[#000]">Пациент</Typography>
          ...
          <Grid item xs={6} className="h-[100%] flex flex-col gap-1 w-full">
      ...
      <Grid item xs={12} className="bg-[#fff] min-h-[100px] mt-[10px] p-[5px]">
        <Typography className="text-[14px] text-[#000]">
      ...
      <Grid item md={12} className="bg-[#fff] min-h-[50px] mt-[10px] p-[5px]">
        <Typography className="text-[14px] text-[#000]">
